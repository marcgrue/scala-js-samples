...
@"__const::1" = private unnamed_addr constant { i8*, i32, i32, i32, i8* } { i8* bitcast ({ { i32, i8*, i8 }, i64, { i32, i32 }, { i32, i8*, i8*, i8* }, { i8* }, [5 x i8*] }* @"java.lang.String::type" to i8*), i32 2093989290, i32 29, i32 0, i8* bitcast ({ i8*, i32, i32, [29 x i16] }* @"__const::0" to i8*) }
...
@"java.util.concurrent.Executor::type" = constant { i32, i8*, i8 } { i32 25, i8* bitcast ({ i8*, i32, i32, i32, i8* }* @"__const::1" to i8*), i8 1 }