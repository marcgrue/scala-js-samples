...
declare void @"Foo$::main_scala.scalanative.runtime.ObjectArray_unit"(i8*, i8*)
...
_9.3:
  %_4 = invoke i8* () @"Foo$::load"() to label %_9.4 unwind label %_8.0
_9.4:
  invoke void (i8*, i8*) @"Foo$::main_scala.scalanative.runtime.ObjectArray_unit"(i8* %_4, i8* %_6) to label %_9.5 unwind label %_8.0
_9.5:
